...
SECRET_KEY = 'k_1i!xbs$3fsh%sh-$ol)cu2d!6u92a@@%-$vrrkf&4fnm0!et'
...
MIDDLEWARE = [
    ...
    'sale.middleware.LoginRequiredMiddleware'
...
LOGIN_REDIRECT_URL = '/categry/'
LOGOUT_REDIRECT_URL = '/categry/'
LOGIN_URL = '/categry/login/'
